...
L["debug_chattype_not_active"] = "ModifyChatMessage: chatType '%s' nicht in aktiver Kanalliste. gilde=%s gruppe=%s schlachtzug=%s instanz=%s"
L["debug_combat_lockdown"] = "ModifyChatMessage: Kampf-Lockdown aktiv, Textänderung übersprungen (verhindert Taint)"
